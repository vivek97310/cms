			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 style="color: #3d56d8;"> History </h4><br>
                        ...
                        <div class="col-sm-12">
                            <table class="data-table table stripe hover nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $s_no=0;
                                        $querystring="select * from fca_view_history where status=1 and start_time between '$fromdate 00:00:00' and '$todate 23:59:59' and con_id IN (select con_id from fca_connectors where charger_id in ($charger_id) ) order by transaction_id desc";
                                        $_SESSION["query"]=$querystring;
                                        $query1 = mysqli_query($connect,$querystring);
