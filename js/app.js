...
var checkout = $('.date-picker').datepicker({
    ...
    var handleFormValidation = function () {
			...
			/*var frm_addmaterial_val = $('#frm_addmaterial');
				var frm_addmaterial_error = $('.alert-error', frm_addmaterial_val);
				var frm_addmaterial_success = $('.alert-success', frm_addmaterial_val);

				frm_addmaterial_val.validate({
					...
					invalidHandler: function (event, validator) { //display error alert on form submit              
						frm_addmaterial_success.hide();
						frm_addmaterial_error.show();
						App.scrollTo(frm_addmaterial_error, -200);
					},
					...
					submitHandler: function (form) {
						  ...
						  frm_addmaterial_success.show();
						  
						  frm_addmaterial_error.hide();
						
						document.frm_addmaterial.submit();
