...
<?php
    ...
    $query = mysqli_query($connect,"select * from `client_registration` where network_id='$network_id'");
    if(mysqli_num_rows($query)>0)
    {
        while($row=mysqli_fetch_array($query))
        {
            ...
            $mobile_db = $row['company_mobile'];
            $landline_db = $row['company_landline'];
            $email_db = $row['company_mail'];
            ...
            $region_db = $row['region'];

            $bank_name_db = $row['bank_name'];
            $branch_name_db = $row['branch_name'];
            $account_number_db = $row['account_number'];
            $account_name_db = $row['account_name'];
            $ifsc_code_db = $row['ifsc_code'];
    ...
    {   
        ...
        //     {
        //         $client_name_check = $row['client_name'];
        //     }
        // }
        // else
        // {
        ...
        // if($client_name_check != $client_name)
        // {

            $update_query = mysqli_query($connect,"UPDATE `client_registration` SET `company_name`='$company_name',`company_mobile`='$mobile',`company_landline`='$landline',`company_mail`='$email',`aadhaar`='$aadhaar',`gst`='$gst',`pan`='$pan',`address`='$address',`pincode`='$pincode',`city`='$city',`state`='$state',`country`='$country',`region`='$region',`bank_name`='$bank_name',`branch_name`='$branch_name',`account_number`='$account_number',`account_name`='$account_name',`ifsc_code`='$ifsc_code' WHERE `network_id` = '$network_id'");
            ...
            if($update_query)
            {
                ...
                //             </div>';
                            ...
                            <script type="text/javascript">
                                ...
                                alert("Network Details are Updated");
                            </script>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="pd-20 card-box mb-30"> 
                <h2 style="text-align: center; color: #e41e1b;"> <b> Network Updation </b> </h2> <br><br>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label> Network Name : <span class="text-danger">(You can't change Network Name)</span> </label>
                                        <input type="text" name="client_name" id="client_name" class="form-control" value="<?php echo $client_name_db; ?>" disabled="true"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="company_name" id="company_name" class="form-control" value="<?php echo $company_name_db; ?>" />
                                        <span id="error_company_name" class="text-danger"></span>
                                    </div><br>
                                    <div class="form-group">
                                        <label> Mobile Number :  <span class="text-danger">(*)</span> </label>
                                        <input type="number" name="mobile" id="mobile" class="form-control" value="<?php echo $mobile_db; ?>" />
                                        <span id="error_mobile" class="text-danger"></span>
                                    </div><br>
                                    <div class="form-group">
                                        <label> Landline Number : </label>
                                        <input type="number" name="landline" id="landline" class="form-control" value="<?php echo $landline_db; ?>" />
                                        <!-- <span id="error_password" class="text-danger"></span> -->
                                    </div><br>
                                    <div class="form-group">
                                        <label> Email ID :  <span class="text-danger">(*)</span> </label>
                                        <input type="text" name="email" id="email" class="form-control" value="<?php echo $email_db; ?>" />
                                        <span id="error_email" class="text-danger"></span>
                                    </div><br>
                                    <div class="form-group">
                                        <label> Aadhaar Number :  <span class="text-danger">(*)</span> </label>
                                        <input type="number" name="aadhaar" id="aadhaar" class="form-control" value="<?php echo $aadhaar_db; ?>" />
                                        <span id="error_aadhaar" class="text-danger"></span>
                                    </div><br>
                                    <div class="form-group">
                                        <label> GST Number :  <span class="text-danger">(*)</span> </label>
                                        <input type="text" name="gst" id="gst" class="form-control" value="<?php echo $gst_db; ?>" />
                                        <span id="error_gst" class="text-danger"></span>
                                    </div><br>
                                    <div class="form-group">
                                        <label> PAN Number :  <span class="text-danger">(*)</span> </label>
                                        <input type="text" name="pan" id="pan" class="form-control" value="<?php echo $pan_db; ?>" />
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" id="address" class="form-control"><?php echo $address_db; ?></textarea>
                                        <span id="error_address" class="text-danger"></span>
                                    </div><br>
                                    
                                    <div class="form-group">
                                        <label> Pincode :  <span class="text-danger">(*)</span> </label>
                                        <input type="number" name="pincode" id="pincode" class="form-control" value="<?php echo $pincode_db; ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="city" name="city" data-live-search="true">
                                            <?php
                                                ...
                                                {
                                                    ?><option value="<?php echo $row['cityfullname']; ?>" 
                                                        <?php
                                                            if($row['cityfullname'] == $city_db)
                                                            {
                                                                echo "selected";
                                                            }
                                                        ?> > <?php echo $row['cityfullname']; ?></option><?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="state" name="state">
                                            <option value="<?php echo $state_db; ?>"> <?php echo $state_db; ?></option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="country" name="country">
                                            <option value="<?php echo $country_db; ?>"> <?php echo $country_db; ?></option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="region" name="region">
                                            <option value="<?php echo $region_db; ?>"> <?php echo $region_db; ?></option>
                                        </select>
                                    </div><br>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bank_name" id="bank_name" class="form-control" value="<?php echo $bank_name_db; ?>" />
                                        <span id="error_bank_name" class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label> Branch Name <span class="text-danger">(*)</span> </label>
                                        <input type="text" name="branch_name" id="branch_name" class="form-control" value="<?php echo $branch_name_db; ?>" />
                                        <span id="error_branch_name" class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label> Account Number <span class="text-danger">(*)</span> </label>
                                        <input type="text" name="account_number" id="account_number" class="form-control" value="<?php echo $account_number_db; ?>" />
                                        <span id="error_account_number" class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label> Account Name <span class="text-danger">(*)</span> </label>
                                        <input type="text" name="account_name" id="account_name" class="form-control" value="<?php echo $account_name_db; ?>" />
                                        <span id="error_account_name" class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label> IFSC Code <span class="text-danger">(*)</span></label>
                                        <input type="text" name="ifsc_code" id="ifsc_code" class="form-control" value="<?php echo $ifsc_code_db; ?>" />
