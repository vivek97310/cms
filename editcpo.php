...
<?php
    ...
    $select_query1 = mysqli_query($connect,"select * from `fca_cpo` where cpo_id='$cpo_id'");
    if(mysqli_num_rows($select_query1)>0)
    {
        while($select_row1=mysqli_fetch_array($select_query1))
        {
            $cpo_name_db = $select_row1['cpo_name'];
            $cpo_mobile_db = $select_row1['cpo_mobile'];
            $cpo_landline_db = $select_row1['cpo_landline'];
            $cpo_email_db = $select_row1['cpo_email'];
            // $aadhaar_db = $row['aadhaar'];
            // $gst_db = $row['gst'];
            // $pan_db = $row['pan'];

            $cpo_address_1_db = $select_row1['cpo_address_1'];
            $cpo_address_2_db = $select_row1['cpo_address_2'];
            $cpo_pincode_db = $select_row1['cpo_pincode'];
            $cpo_city_db = $select_row1['cpo_city'];
            $cpo_state_db = $select_row1['cpo_state'];
            $cpo_country_db = $select_row1['cpo_country'];
        }
    }
    else
    {
    ...
    $select_query2 = mysqli_query($connect,"select * from `fca_cpo_bank` where cpo_id='$cpo_id'");
    if(mysqli_num_rows($select_query2)>0)
    {
        while($select_row2=mysqli_fetch_array($select_query2))
        {
            $cpo_bank_name_db = $select_row2['cpo_bank_name'];
            $cpo_branch_name_db = $select_row2['cpo_branch_name'];
            $cpo_account_number_db = $select_row2['cpo_account_number'];
            $cpo_account_name_db = $select_row2['cpo_account_name'];
            $cpo_ifsc_code_db = $select_row2['cpo_ifsc_code'];
        }
    }
    else
    {
    ...
    // {
        ...
        else
        {
            $message = '<div class="alert alert-danger">
                            There is an error in CPO Updation
                        </div>';
        }
    // }
    // else
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="pd-20 card-box mb-30"> 
                <h2 style="text-align: center; color: #3d56d8;"> <b> CPO Updation </b> </h2> <br><br>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cpo_name" id="cpo_name" class="form-control" value="<?php echo $cpo_name_db; ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="mobile" id="mobile" class="form-control" value="<?php echo $cpo_mobile_db; ?>" />
                                        <span id="error_mobile" class="text-danger"></span>
                                    </div><br>
                                    <div class="form-group">
                                        <label> Landline Number : </label>
                                        <input type="number" name="landline" id="landline" class="form-control" value="<?php echo $cpo_landline_db; ?>" />
                                        <!-- <span id="error_password" class="text-danger"></span> -->
                                    </div><br>
                                    <div class="form-group">
                                        <label> Email ID :  <span class="text-danger">(*)</span> </label>
                                        <input type="text" name="email" id="email" class="form-control" value="<?php echo $cpo_email_db; ?>" />
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address_1" id="address_1" class="form-control" value="<?php echo $cpo_address_1_db; ?>">
                                        <span id="error_address_1" class="text-danger"></span>
                                    </div><br>

                                    <div class="form-group">
                                        <label> Address Line 2 : </label>
                                        <input type="text" name="address_2" id="address_2" class="form-control" value="<?php echo $cpo_address_2_db; ?>">
                                    </div><br>
                                    
                                    <div class="form-group">
                                        <label> Pincode :  <span class="text-danger">(*)</span> </label>
                                        <input type="number" name="pincode" id="pincode" class="form-control" value="<?php echo $cpo_pincode_db; ?>"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="city" id="city" class="form-control" value="<?php echo $cpo_city_db; ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="state" name="state" data-live-search="true" class="form-control">
                                            ...
                                            <?php
                                                ...
                                                while($row = mysqli_fetch_array($result))
                                                {
                                                    ?><option value="<?php echo $row['statefullname']; if($cpo_state_db == $row['statefullname']) echo '"selected=selected"'; ?>"><?php echo $row["statefullname"];?></option><?php
                                                }
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="country" name="country">
                                            <?php
                                                $result = mysqli_query($connect,"SELECT distinct(countryfullname) FROM fca_cities order by countryfullname asc");
                                                while($row = mysqli_fetch_array($result))
                                                {
                                                    $cpo_country_db1 = $row['countryfullname'];
                                                    ?><option value="<?php echo $cpo_country_db1; ?>" <?php if($cpo_country_db1 == $cpo_country_db) echo 'selected="selected"' ?> > <?php echo $row["countryfullname"]; ?></option><?php
                                                }
                                            ?>
                                        </select>
                                    </div><br>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bank_name" id="bank_name" class="form-control" value="<?php echo $cpo_bank_name_db; ?>" />
                                        <span id="error_bank_name" class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label> Branch Name <span class="text-danger">(*)</span> </label>
                                        <input type="text" name="branch_name" id="branch_name" class="form-control" value="<?php echo $cpo_branch_name_db; ?>" />
                                        <span id="error_branch_name" class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label> Account Number <span class="text-danger">(*)</span> </label>
                                        <input type="text" name="account_number" id="account_number" class="form-control" value="<?php echo $cpo_account_number_db; ?>" />
                                        <span id="error_account_number" class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label> Account Name <span class="text-danger">(*)</span> </label>
                                        <input type="text" name="account_name" id="account_name" class="form-control" value="<?php echo $cpo_account_name_db; ?>" />
                                        <span id="error_account_name" class="text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label> IFSC Code <span class="text-danger">(*)</span></label>
                                        <input type="text" name="ifsc_code" id="ifsc_code" class="form-control" value="<?php echo $cpo_ifsc_code_db; ?>">
    ...
    function preview()
    {
        ...
        ifsc_code_value.innerText = ifsc_code;
                        ...
                        <div class="tab-pane fade" id="preview_details">
                            <div class="panel panel-default">
                                <div class="panel-heading"> CPO Preview </div>
                                <div class="panel-body"><br>
                                    ...
                                    <div align="center">
                                        ...
                                        <button type="button" name="btn_preview_details" id="btn_preview_details" class="btn btn-success"> Update </button>
                                    </div><br>
                                </div>
                            </div>
                        </div>
